...
export default function IncomePage() {
  ...
  const fetchAccounts = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch(`${API_URL}/accounting/accounts?type=income`, {
    ...
    <ProtectedRoute requiredModule="cbs">
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Chart of Accounts - Income Accounts</p>
        </div>
            ...
            <div className="divide-y divide-gray-200">
              {tree.length === 0 ? (
                <div className="p-6 text-center text-gray-500">
                  No income accounts found. Please seed the chart of accounts first.
                </div>
              ) : (
