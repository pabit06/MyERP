...
import { Mail, Lock, ArrowRight, Loader2, Building2, Eye, EyeOff, AlertCircle, CheckCircle2 } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col justify-between w-full p-12 lg:p-16">
          ...
          <div className="space-y-6 max-w-lg animate-fade-up">
            ...
            <p className="text-lg text-blue-50 leading-relaxed">
              ...
              management solution built for modern cooperatives.
            </p>
          ...
          <nav aria-label="Footer navigation" className="flex items-center justify-between text-sm text-blue-100 animate-fade-in">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-8 lg:p-12 xl:p-16 relative z-10">
        ...
        <div className="w-full max-w-md space-y-8 animate-fade-up relative z-10">
          ...
          <header className="text-center lg:text-left">
            ...
            <p className="mt-2 text-base text-slate-900">Please enter your details to sign in to your account.</p>
          </header>
          ...
          <main id="main-content">
                  ...
                  <div className="relative">
                    ...
                    >
                      <Mail className={`h-5 w-5 transition-colors duration-200 ${
                        emailError ? 'text-red-500' : email ? 'text-indigo-600' : 'text-slate-500 group-focus-within:text-indigo-600'
                      }`} />
                    </div>
                    <input
                      id="email"
                      ...
                      aria-describedby={emailError ? 'email-error' : email && !emailError ? 'email-success' : undefined}
                    ...
                    {email && !emailError && (
                      <div
                        ...
                        aria-hidden="true"
                      >
                        <CheckCircle2 className="h-5 w-5 text-green-600" aria-label="Email is valid" />
                      </div>
                    )}
                  </div>
                  {emailError && (
                ...
                <div className="relative">
                  ...
                  >
                    <Lock className={`h-5 w-5 transition-colors duration-200 ${
                      passwordError ? 'text-red-500' : password ? 'text-indigo-600' : 'text-slate-500 group-focus-within:text-indigo-600'
                    }`} />
                  </div>
                  <input
                    id="password"
                    ...
                    aria-describedby={passwordError ? 'password-error' : 'password-toggle-description'}
            ...
            >
              {isLoading ? (
                ...
                <>
                  <span>Sign in</span>
                  <ArrowRight className="ml-2.5 h-5 w-5 group-hover:translate-x-1 transition-transform duration-200" aria-hidden="true" />
                </>
              )}
            </button>
          </form>
