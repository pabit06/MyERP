  ...
  const navigationItems: NavItem[] = useMemo(
    () => [
      ...
      },
      {
        ...
        group: 'governance',
        submenu: [
          { label: 'Dashboard', href: '/governance/budget', icon: LayoutDashboard },
          { label: 'Create Budget', href: '/governance/budget/create', icon: Plus },
          { label: 'Board Approval', href: '/governance/budget/approval', icon: CheckCircle2 },
          { label: 'AGM Agenda', href: '/governance/budget/agm', icon: Vote },
          { label: 'Budget Reports', href: '/governance/budget/reports', icon: BarChart3 },
        ],
      },
      {
        label: 'AGM',
